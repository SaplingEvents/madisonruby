...
namespace :sponsors do
  ...
  task :seed => [:environment] do
    ...
    Sponsor.create(name: "Bendyworks", image_path: "logo_bendyworks.png", url: "http://www.bendyworks.com", ranking: 2)
    ...
    Sponsor.create(name: "Blue Box Group", image_path: "logo_blue_box_group.png", url: "logo_blue_box_group.png", ranking: 3)
